...
namespace Drupal\slavnews_fieldformatter\Plugin\Field\FieldFormatter;
 ...
 *
 * @FieldFormatter(
 *   id = "slavnews_fieldformatter",
 *   label = @Translation("Display Only first Image"),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
...
class SlavnewsFieldFormatter extends ImageFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    // Adding render array items to my one item that i will return.
    $render_array[] = [
      '#theme' => 'image_formatter',
      '#item' => $media->get('thumbnail')->first(),
      '#item_attributes' => [],
      '#image_style' => $this->getSetting('image_style'),
      // Getting Link to the entity url.
