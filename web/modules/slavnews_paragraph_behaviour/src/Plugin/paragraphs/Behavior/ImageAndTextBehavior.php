...
namespace Drupal\slavnews_paragraph_behaviour\Plugin\paragraphs\Behavior;
...
class ImageAndTextBehavior extends ParagraphsBehaviorBase {
  ...
  public function view(array &$build, Paragraph $paragraph, EntityViewDisplayInterface $display, $view_mode) {
    ...
    $image_position = $paragraph->getBehaviorSetting($this->getPluginId(), 'image_position', 'none');
    ...
    if ($build['field_paragraph_media_']['#formatter'] == 'image') {
      switch ($image_size) {
        case '6_12':
          $build['field_paragraph_media_'][0]['#image_style'] = 'image_and_text_6_of_12';
          break;

        case '8_12':
          $build['field_paragraph_media_'][0]['#image_style'] = 'image_and_text_8_of_12';
          break;
      }
    }
  }
